...
#ifndef PEANOCLAW_GRID_PLOTTER_VTUSUBGRIDPLOTTER_H_
#define PEANOCLAW_GRID_PLOTTER_VTUSUBGRIDPLOTTER_H_
...
namespace peanoclaw {
  ...
  namespace grid {
    ...
    namespace plotter {
      class VTUSubgridPlotter;
    }
  }
}

class peanoclaw::grid::plotter::VTUSubgridPlotter : public peanoclaw::grid::plotter::SubgridPlotter {
private:
  /**
   * Logging device.
   */
   ...
   * subwriters.
   */
  tarch::plotter::griddata::unstructured::binaryvtu::BinaryVTUTextFileWriter _vtuWriter;
...
#endif /* PEANOCLAW_GRID_PLOTTER_VTUSUBGRIDPLOTTER_H_ */
